<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EmployeeLogin.aspx.vb" Inherits="AutomatedPayrollSystem.EmployeeAdmin" %>
...
<table id="Table1" align="center" class="auto-style1"  runat="server">
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>
                    <asp:TextBox ID="inemail" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>&nbsp;</td>
                <td>
                    <asp:TextBox ID="inpass" runat="server" TextMode="Password" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
